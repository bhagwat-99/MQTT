...
// //certificate path
// char * cafile = "/etc/gateway/certificates/test_device2.cert.pem";
// char * cert = "/etc/gateway/certificates/root-CA.crt";
// char * key = "/etc/gateway/certificates/test_device2.private.key";


//certificate path
char * cafile = "/certificates/test_device.pem";
char * cert = "/certificates/root-CA.crt";
char * key = "/certificates/test_device_private.key";
