...
#define PUB_TOPIC1               "gateway/telemetrydata/G001"
#define PUB_TOPIC2              "gateway/status/G001"
#define SUB_TOPIC1              "gateway/request/G001"
...
int main(int argc, char* argv[])
{
    ...
    if ((rc = MQTTClient_subscribe(client, SUB_TOPIC1, QOS)) != MQTTCLIENT_SUCCESS)
    {
