...
#define PUB_TOPIC_THING             "$aws/provisioning-templates/gateway_template/provision/json"
...
#define SUB_TOPIC_THING_ACCEPT      "$aws/provisioning-templates/gateway_template/provision/json/accepted"
#define SUB_TOPIC_THING_REJECT      "$aws/provisioning-templates/gateway_template/provision/json/rejected"
